...
<tr>
    <td colspan="2" class="clear">
        <textarea id="wr_content" name="wr_content" class="wr_content" style='width:100%;height:150px; word-break:break-all;' itemname="내용" required
...
<tr>
    <td colspan="2" style="line-height:0;vertical-align:middle;">       
       	<div style="float:left;margin-left:2px;width:70%">
	        <? if ($is_guest) { ?>
	        ...
	        <? if ($is_guest) { ?>
	            , 오른쪽 이미지의 글자를 입력하세요 :
	            <input title="오른쪽의 글자를 입력하세요." type="input" name="wr_key" size="10" itemname="자동등록방지" required class=ed>
        ...
        <div style="float:right;margin-right:2px;">
        	<span class="button green"><input type="submit" value="댓글작성"></span>
        </div>        
    </td>
</tr>
</table>
