...
축하합니다!. <b>나린위키</b>를 설치하였습니다. 

<h3>나린위키 설정</h3>
위키를 사용하기 위해서 다음의 설정을 해야 합니다.
<ul>
	<li>그누보드의 <b>head.sub.php</b> 의 <u>&lt;body&gt; 태그위</u>에 다음 코드를 넣어주세요
<pre style="border:1px dashed #ccc;padding:5px;background-color:#F0F4F7;"><span style="color: #000000; font-weight: bold;">&lt;?</span> <span style="color: #b1b100;">if</span><span style="color: #009900;">&#40;</span><a href="http://www.php.net/defined"><span style="color: #990000;">defined</span></a><span style="color: #009900;">&#40;</span><span style="color: #0000ff;">&quot;__NARINWIKI__&quot;</span><span style="color: #009900;">&#41;</span><span style="color: #009900;">&#41;</span> <span style="color: #b1b100;">include_once</span> <span style="color: #000088;">$wiki</span><span style="color: #009900;">&#91;</span>path<span style="color: #009900;">&#93;</span><span style="color: #339933;">.</span><span style="color: #0000ff;">&quot;/inc/inc.head.sub.php&quot;</span><span style="color: #F0F4F7;">;</span> <span style="color: #000000; font-weight: bold;">?&gt;</span></pre>
</li>
<? if($add) echo "<li>$add</li>";	?>
<li>위키로 사용할 게시판의 여분필드 1의 제목을 <u>narinwiki</u> 로 설정하고, 여분필드 1의 내용에 <u><?=$wiki_path?></u> 를 입력하세요</li>
<li>"http://나린위키/narin.php?bo_table=게시판아이디" 로 나린위키 링크를 만들어 사용하세요</li>
</ul>

<h3>나린위키 기부</h3>
<div style="">	
	나린위키는 무료 오픈소스 소프트웨어입니다. 누구나 무료로 다운받을 수 있고 사용할 수 있습니다. <br/>
	
	나린위키를 제작, 유지보수, 업데이트 하는데 많은 시간과 노력이 필요합니다. 기업/기관에서 나린위키를 사용하신다면 더 좋은 소프트웨어를 위해 기부를 생각해보세요. 
	개인도 환영입니다. ^^ <br/>
...
<h1>위키 설치</h1>
<form name="frmwikiinstall" action="install.php" onsubmit="return submit_check(this);" method="post">
<input type="hidden" name="md" value="doit"/>
<div class="list_table">
	...
	<tbody>
		<tr>
			...
			<td>
				<textarea style="width:100%; height:200px; padding:5px 2px; margin-bottom:10px;background-color:#f0f0f0;" readonly><?=file_get_contents("LICENSE")?></textarea>
				
				<p>설치를 원하시면 위 내용에 동의하셔야 합니다.</p>
				<input type="checkbox" name="agree" id="agree"><label for="agree"> 네, 동의합니다.</label>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="wiki_path" size="15" required itemname="위키 경로"/>
				&nbsp; (그누보드 폴더로 부터의 상대 경로 e.g. <그누보드>/wiki 일 경우 wiki 입력)
			</td>
		</tr>
		<tr><td colspan="2"><span class="button red"><input type="submit" value=" 설치하기 "/></span></td></tr>
	</tbody>
	</table>
